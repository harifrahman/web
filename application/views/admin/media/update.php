            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <br><br>
                  <!-- ============================================================================ -->
                  <form class="form-horizontal" action="<?=base_url()?>admin/media/update/<?=$row->media_id?>/do_update" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image" value="<?=$row->media_gambar?>">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="body" name="media_isi" rows="7" placeholder="Write here..."><?=$row->media_isi?></textarea>
                    </div>
